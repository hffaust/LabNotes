...
def get_valid_cookie(url,headers,initial_cookies,usern,passw):
    ...
    if "Server responded in " in res:
        ...
        #exit(-1)
    cook = r"SESSIONID_APM_40443=3114A574EA259B490D80026CE0A1F92B; testcookie=; isiframeenabled=true;" 
    cook += r" am_username=; am_check=; memarketing-_zldp=Mltw9Iqq5RTfepL5LIJZ4FOUoFaafn31AygirURDw6IwUQkKYk1hrKJ3Yp%2BLPkutPR%2Fvqf4hTGo%3D;"
    cook += r" memarketing-_zldt=26d058c1-1267-4795-833f-61e4101799d0-0; am_browserCountry=UNITED%20STATES%20OF%20AMERICA; "
    cook += r" csrfToken=0ff800bd-121a-4f24-887d-4df90a2e456a; selectedtabId=hometab; homednd=%5B%7Bbay%3A%27DRAG_APPEND_1%27%2Cchildren%3A%5B%7Btab%3A%27DRAG_1%27%2Cstate%3A%27on%27%2Ccontent%3A%27show…%27on%27%2Ccontent%3A%27show%27%7D%2C%7Btab%3A%27DRAG_12%27%2Cstate%3A%27on%27%2Ccontent%3A%27show%27%7D%5D%7D%2C%7Bbay%3A%27DRAG_APPEND_5%27%2Cchildren%3A%5B%7Btab%3A%27DRAG_8%27%2Cstate%3A%27on%27%2Ccontent%3A%27show%27%7D%2C%7Btab%3A%27DRAG_14%27%2Cstate%3A%27on%27%2Ccontent%3A%27show%27%7D%2C%7Btab%3A%27DRAG_16%27%2Cstate%3A%27on%27%2Ccontent%3A%27show%27%7D%5D%7D%5D;"
    cook += r" allResourceTable_sortdir=down; allResourceTable_sortcol=1; MonitorAvailablityTable_sortdir=down; 10000018_host_seltab=0; selectedtab=7_1"
    return cook
...
def get_base_dir(url,headers,valid_cookie):
    ...
    #pathname = tree.xpath('//*[@id="buildpath"]/@title')
    print(pathname)
    base_dir = pathname
    print("[*] Found base directory: " + base_dir)
    '''

    base_dir = r"C:\Program Files\ManageEngine\AppManager14"
    return base_dir
